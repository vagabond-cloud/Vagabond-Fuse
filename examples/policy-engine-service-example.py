...
def main():
    ...
    try:
        ...
        elif "policy" in updated and "version" in updated["policy"]:
            print(f"  New version: {updated['policy']['version']}")
            print(f"  Rules count: {len(updated['policy']['rules'])}")
        else:
            print(f"  New version: {updated_policy['version']}")
            print(f"  Rules count: {len(updated_policy['rules'])}")
